...
public class RowMajorPackedArrayUnitTest extends PackedArrayUnitTest {
	
	@Override
	protected PackedArray<String> createStringArray(int... sizes) {
		return new RowMajorPackedArray<String>(sizes);
	}
	
	@Test
	public void testElementLayout() {
		RowMajorPackedArray<Object> oneDimArray = new RowMajorPackedArray<Object>(5);
		...
		RowMajorPackedArray<Object> twoDimArray = new RowMajorPackedArray<Object>(3, 3);
		...
		RowMajorPackedArray<Object> threeDimArray = new RowMajorPackedArray<Object>(2, 2, 2);
