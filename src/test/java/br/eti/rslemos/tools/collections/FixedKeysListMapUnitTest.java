...
public class FixedKeysListMapUnitTest extends TestCase {
	public static TestSuite suite() throws Exception {
		TestSuite suite = new TestSuite(FixedKeysListMapUnitTest.class);
		suite.addTest(ListTestSuiteBuilder
				.using(new TestListMapGenerator())
				.named("new FixedKeysListMap[keys]")
				.withFeatures(
	...
	public void testGeneralUsage() {
		FixedKeysListMap<String,String> listMap = new FixedKeysListMap<String, String>("featureA", "featureB", "featureC");
		
		assertThat(listMap.size(), is(equalTo(0)));
		
		Map<String, String> map0 = new HashMap<String, String>();
		map0.put("featureA", null);
		map0.put("featureB", null);
		map0.put("featureC", null);
		
		assertThat(listMap.add(map0), is(equalTo(true)));
	...
	private static final class TestListMapGenerator implements TestListGenerator<Map<String, String>> {
		public List<Map<String, String>> create(Map<String, String>... elements) {
			List<Map<String, String>> fixedSizeListMap = new FixedKeysListMap<String, String>("A", "B", "C", "D");
			for (int i = 0; i < elements.length; i++) {
				Map<String, String> map0 = elements[i];
				fixedSizeListMap.add(map0);
			}
